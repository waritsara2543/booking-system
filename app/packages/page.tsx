...
export default function PackagesPage() {
  ...
  const [currentPackage, setCurrentPackage] = useState<MemberPackage | null>(
    null
  );
    ...
    try {
      ...
      if (data) {
        ...
        if (
          ...
          typeof data.package_details.features === "string"
        ) {
          data.package_details.features = JSON.parse(
            data.package_details.features
          );
        }
  ...
  const isPackageDisabled = (pkg: PackageType) => {
    ...
    const isCurrentPackageExpired =
      currentPackage && new Date(currentPackage.end_date) < new Date();
  ...
  const getButtonText = (pkg: PackageType) => {
    ...
    if (
      ...
      return isCurrentPackageExpired
        ? "Select Package"
        : "Not Available (Lower Tier)";
    }

    return currentPackage?.payment_status === "completed" &&
      !isCurrentPackageExpired
  ...
  const handleSelectPackage = (pkg: PackageType) => {
    ...
    if (
      ...
      toast.error(
        "You can only upgrade to a higher-priced package until your current package expires"
      );
      return;
    }
  ...
  const getFeatureIcon = (feature: string) => {
    ...
    if (
      lowerFeature.includes("computer") ||
      lowerFeature.includes("desktop") ||
      lowerFeature.includes("workstation")
    )
    ...
    if (
      ...
      lowerFeature.includes("date") ||
      lowerFeature.includes("month")
    )
      return <Calendar className="h-4 w-4 text-primary mr-2" />;
    if (
      lowerFeature.includes("guest") ||
      lowerFeature.includes("member") ||
      lowerFeature.includes("person")
    )
  ...
  const getPackageGradient = (index: number) => {
    ...
    if (index === 2)
      return "bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/30 dark:to-amber-900/20";
    if (index >= 3)
      return "bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-950/30 dark:to-rose-900/20";
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Choose the perfect membership package that suits your needs and
              budget
            </p>
            {isLoggedIn ? (
              <p className="text-sm text-muted-foreground">
                ...
                {currentPackage
                  ? "Manage your current package or upgrade below."
          ...
          <>
                ...
                <Card className="border-primary overflow-hidden">
                  ...
                  <div className="p-1">
                    <div
                      className={cn(
                        "rounded-md",
                        getStatusClasses(currentPackage.payment_status)
                      )}
                    >
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <CardTitle className="text-2xl">
                              Your {currentPackage.package_details?.name}{" "}
                              Package
                            </CardTitle>
                              ...
                              <div className="mt-4 flex items-center justify-between">
                                ...
                                <div className="text-right">
                                  ...
                                  <p className="text-xl font-bold text-primary">
                                    ฿
                                    {currentPackage.package_details?.price.toFixed(
                                      2
                                    ) || "0.00"}
                                  </p>
                                </div>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="bg-background/80 rounded-lg p-4">
                                <ul className="space-y-2">
                                  {currentPackage.package_details?.features.map(
                                    (feature, index) => (
                                      <li
                                        key={index}
                      ...
                      <div className="flex items-start w-full">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-red-700 dark:text-red-400">
                            Please select a new package below to continue
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <AlertDescription className="text-amber-700 dark:text-amber-400">
                    You have a pending package selection. Please visit the
                    counter to complete your payment. You can only select one
                    package at a time until it's confirmed.
                  </AlertDescription>
                </Alert>
              </div>
            )}
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-6 shadow-sm border border-blue-100 dark:border-blue-900">
                  <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-blue-700 dark:text-blue-400">
                      Select a package below to get started. You'll need to log
                      in or create an account to complete your purchase.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mb-6">
                Choose from our range of membership packages designed to suit
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {packages.map((pkg, index) => (
                  ...
                  >
                    <CardHeader
                      className={cn("pb-2", getPackageGradient(index))}
                    >
                      <div className="flex justify-between items-start">
            ...
            <div className="mt-12 bg-muted/50 rounded-lg p-6">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Our team is ready to help you find the perfect membership
